...
Three_wheeled_base_d319c82e_1_NeDaePrivateData_create ( NeDaePrivateData *
smData ) ; void Three_wheeled_base_d319c82e_1_dae ( NeDae * * dae , const
...
Three_wheeled_base_d319c82e_1_NeDaePrivateData_create ( smData ) ; * dae =
