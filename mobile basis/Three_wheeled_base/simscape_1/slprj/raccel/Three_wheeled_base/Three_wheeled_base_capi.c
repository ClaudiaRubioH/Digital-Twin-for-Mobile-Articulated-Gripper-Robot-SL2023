...
"Three_wheeled_base/Solver Configuration/EVAL_KEY/STATE_1" ) , TARGET_STRING
( "" ) , 0 , 0 , 0 , 0 , 0 } , { 0 , 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 , 0
, 0 } } ; static const rtwCAPI_BlockParameters rtBlockParameters [ ] = { { 0
...
static void * rtDataAddrMap [ ] = { & rtB . myzglu2kvm [ 0 ] , } ; static
...
8 , 1 } ; static const real_T rtcapiStoredFloats [ ] = { 0.0 } ; static const
...
{ rtBlockParameters , 0 , rtModelParameters , 0 } , { ( NULL ) , 0 } , {
rtDataTypeMap , rtDimensionMap , rtFixPtMap , rtElementMap , rtSampleTimeMap
, rtDimensionArray } , "float" , { 1139277237U , 1983258114U , 1374823479U ,
448231610U } , ( NULL ) , 0 , ( boolean_T ) 0 , rt_LoggedStateIdxList } ;
const rtwCAPI_ModelMappingStaticInfo * Three_wheeled_base_GetCAPIStaticMap (
void ) { return & mmiStatic ; }
#ifndef HOST_CAPI_BUILD
void Three_wheeled_base_InitializeDataMapInfo ( void ) { rtwCAPI_SetVersion (
